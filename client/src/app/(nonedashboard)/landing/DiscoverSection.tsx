        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16 text-center">
          {[
            ...
            },
            {
              ...
              description:
                "Once you've found the perfect property, our platform makes it easy to book your rental online with just a few clicks.",
            },
            {
              imageSrc: "/landing-icon-heart.png",
              title: "Enjoy your New Home",
              description:
                "Experience the comfort and convenience of your new rental home, tailored to your lifestyle.",
            },
          ].map((card, index) => (
